...
### Core Meta Tags
```html
<title>FitCast Challenges - Fitness con Recompensas Crypto | Mini App Farcaster</title>
<meta name="description" content="Únete a desafíos fitness diarios, gana tokens reales y comparte tu progreso en Farcaster. La primera Mini App que combina fitness con Web3." />
<meta name="keywords" content="fitness, crypto, farcaster, web3, challenges, tokens, base, miniapp" />
```

### Open Graph Tags
```html
<meta property="og:title" content="FitCast Challenges - Fitness con Recompensas Crypto" />
