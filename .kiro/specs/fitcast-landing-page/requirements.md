...
FitCast Challenges Landing Page es una página web profesional que servirá como punto de entrada principal para la Mini App de Farcaster. La landing page debe comunicar efectivamente la propuesta de valor única de FitCast, convertir visitantes en usuarios activos, y establecer credibilidad en el ecosistema Web3 fitness. Construida con NextJS 14, TypeScript y TailwindCSS, debe ser completamente responsive, optimizada para SEO, y preparada para integración con MiniKit de Base.

## Requirements

### Requirement 1

**User Story:** Como visitante interesado en fitness y Web3, quiero entender rápidamente qué es FitCast Challenges y cómo me beneficia, para decidir si quiero probar la aplicación.
...
2. WHEN un usuario lee el hero section THEN el sistema SHALL presentar el mensaje "Desafíos fitness con recompensas crypto reales en Farcaster" de forma prominente
3. WHEN un usuario ve el hero section THEN el sistema SHALL incluir un CTA principal "Comenzar Desafío" que destaque visualmente
...
**User Story:** Como usuario interesado en las características de FitCast, quiero ver una sección detallada de features que explique cómo funciona la plataforma, para entender el valor completo antes de registrarme.
...
**User Story:** Como usuario que quiere ver FitCast en acción, quiero acceder a una demo interactiva o preview, para entender mejor cómo funciona antes de comprometerme.
...
**User Story:** Como usuario convencido de probar FitCast, quiero un proceso claro y directo para comenzar, para poder acceder rápidamente a la Mini App sin fricción.
...
**User Story:** Como usuario que quiere compartir FitCast con amigos o en redes sociales, quiero que la página tenga metadatos optimizados, para que se vea profesional cuando la comparta.
